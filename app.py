...
def main():
    ...
    st.markdown('<p style="text-align: center;">Example inputs: "I am starting to believe", "The moon landing never happened", "The theory about"</p>', unsafe_allow_html=True)
